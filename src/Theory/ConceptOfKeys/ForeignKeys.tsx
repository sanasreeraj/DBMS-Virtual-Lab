    ...
    content: `
      <div class="space-y-6 max-w-4xl mx-auto p-6">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-green-600">What is a Foreign Key?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              A <strong class="text-green-600">foreign key</strong> is a column or a set of columns in one table that refers to the primary key in another table. It is used to maintain relationships between tables and ensure data integrity.
            </p>
          </div>
        </div>
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-green-600">Example</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
            ...
            <div class="space-y-4">
              ...
              <div class="bg-green-50 rounded-lg p-4">
                <h4 class="font-bold text-green-600 mb-2">1. Students Table (Primary Table)</h4>
