  ...
  return {
    ...
    content: `
      <div class="space-y-6 max-w-4xl mx-auto p-6">
        <!-- Header Section -->
        <div class="bg-gradient-to-r from-blue-600 to-teal-600 rounded-xl p-6 text-white shadow-lg">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-teal-600">Alternate Key</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              An <strong class="text-teal-600">alternate key</strong> is a candidate key that is not chosen as the primary key. It can still uniquely identify rows but remains as a backup. There can be multiple alternate keys in a table, and they can be used as secondary unique identifiers.
            </p>
            <div class="bg-teal-50 rounded-lg p-4 mt-4">
              <h4 class="font-bold text-teal-600 mb-2">Example:</h4>
              <div class="space-y-2">
                <div class="flex items-center space-x-2">
                  <i class="fas fa-table w-4 h-4 text-teal-600"></i> <!-- Replace with your icon implementation -->
                  <span class="font-semibold">Table: Employee</span>
                  <span class="text-gray-600">(EmpID, Name, Email, Phone)</span>
                </div>
                <div class="pl-6 text-gray-700">
              ...
              <table class="w-full">
                <thead>
                  <tr class="bg-gray-50">
                    ...
                    <th class="px-6 py-4 text-left text-sm font-semibold text-teal-600">Alternate Key</th>
                  </tr>
                </thead>
