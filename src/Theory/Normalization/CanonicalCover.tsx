    ...
    content: `
      <div class="space-y-6 max-w-4xl mx-auto p-6">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">What is a Canonical Cover?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              A <strong class="text-orange-600">canonical cover</strong> (or minimal cover) is the smallest equivalent set of functional dependencies (FDs) without redundancy. It simplifies FDs before database design by removing unnecessary dependencies and merging overlapping ones.
            </p>
          </div>
        </div>
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-red-600">How to Find a Canonical Cover?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
