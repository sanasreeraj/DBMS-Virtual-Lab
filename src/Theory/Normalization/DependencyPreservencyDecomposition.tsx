    ...
    content: `
      <div class="space-y-6 max-w-4xl mx-auto p-6">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">What is Dependency Preserving Decomposition?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              A decomposition is <strong class="text-orange-600">dependency preserving</strong> if all functional dependencies remain enforceable in the decomposed tables without needing extra joins. This ensures that the integrity constraints of the original table are maintained in the decomposed tables.
            </p>
          </div>
        </div>
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-red-600">Example</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">Note</h3>
            </div>
            <ul class="list-disc list-inside text-gray-700 leading-relaxed space-y-2">
