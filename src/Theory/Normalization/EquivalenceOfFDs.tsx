        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">What is Equivalence of FDs?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              Two sets of functional dependencies are <strong class="text-orange-600">equivalent</strong> if they produce the same closure (i.e., determine the same attributes). This means that both sets can derive the same functional dependencies.
            </p>
          </div>
        </div>
