        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">What is Normalization?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              <strong class="text-orange-600">Normalization</strong> is a process in database design to remove redundancy and ensure data integrity. It organizes tables efficiently by dividing larger tables into smaller ones and establishing relationships.
            </p>
          </div>
        </div>
