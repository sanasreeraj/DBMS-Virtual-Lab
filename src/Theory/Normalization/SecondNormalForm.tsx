    ...
    content: `
      <div class="space-y-6 max-w-4xl mx-auto p-6">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">What is Second Normal Form (2NF)?</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
              A table is in <strong class="text-orange-600">Second Normal Form (2NF)</strong> if:
            </p>
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-red-600">Example (Before 2NF)</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
        ...
        <div class="hover:shadow-lg transition-shadow duration-300 bg-white rounded-lg">
          <div class="p-6">
            <div class="flex items-center space-x-3 mb-4">
              <h3 class="text-xl font-bold text-orange-600">Example (After 2NF)</h3>
            </div>
            <p class="text-gray-700 leading-relaxed mb-4">
